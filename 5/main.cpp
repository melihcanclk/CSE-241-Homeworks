...
int main(){
    ...
    cout << "Number Of board created so far is "<< Puzzle::AbstractClass::numberOfBoards<< endl;
    //Names of files
    char *fileName[30];

    for(int i=0 ;i<Puzzle::AbstractClass::numberOfBoards;i++){
   ...
   for(int i=0;i<Puzzle::AbstractClass::numberOfBoards;i++){
    ...
    for(int i=0;i<Puzzle::AbstractClass::numberOfBoards;i++){
        for(int j = i+1; j<Puzzle::AbstractClass::numberOfBoards;j++){
